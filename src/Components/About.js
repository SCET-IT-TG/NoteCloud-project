  ...
  return (
    <div className='container my-3'>
      ...
      <p><b>Our Vision:</b><br />
        ...
        <br/>
        <b>Join Us</b><br />
        Be part of our growing community and experience the convenience of cloud-based note storage. Sign up today and take your notes wherever you go!
        <br />
        For any questions or support, feel free to reach out to us at <b>[support@notecloud.com]</b>.
        <br />
        <b>Stay organized. Stay inspired. Welcome to NoteCloud!</b></p>
    </div>
  )
}
